...
public class TrelloClientTest {
    ...
    public void init() {
        ...
        when(trelloConfig.getTrelloUsername()).thenReturn("adriansionek");
    }
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        URI uri = new URI("http://test.com/members/adriansionek/boards?key=test&token=test&fields=name,id&lists=all");
    ...
    @Test
    public void shouldReturnEmpty() throws URISyntaxException{
        //Given
        URI uri = new URI("http://test.com/members/adriansionek/boards?key=test&token=test&fields=name,id&lists=all");
