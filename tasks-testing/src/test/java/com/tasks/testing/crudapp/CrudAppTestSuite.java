package com.tasks.testing.crudapp;
...
public class CrudAppTestSuite {
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElements(By.xpath("//a[@class=\"board-tile\"]")).stream()
                .filter(aHref -> aHref.findElements(By.xpath("//div[contains(@title, \"Witaj w Trello\")]")).size() > 0)
    ...
    public void deleteCrudAppTestTask(String taskName) throws InterruptedException {
        ...
        final String XPATH_DELETE_BUTTON = "//form[@data-task-id=\"35\"]//button[4]";
